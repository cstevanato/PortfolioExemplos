...
@Composable
fun BlurredAnimateText(modifier: Modifier = Modifier, text: String) {
    val blurList = text.mapIndexed { index, charecter ->
        if (charecter == ' ') {
            remember {
            ...
            infiniteTransition.animateFloat(
                ...
                animationSpec = infiniteRepeatable(
                    ...
                    initialStartOffset = StartOffset((ANIMATION_DURATION / text.length) * index)
                ),
...
@Preview
@Composable
private fun BlurredAnimateTextPreview() {
    PortfolioExemplosTheme {
        BlurredAnimateText(text = "Exemplo")
    }
}